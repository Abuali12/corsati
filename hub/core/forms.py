...
class CourseForm(forms.ModelForm):
    class Meta:
        model= Course
        fields= ['title', 'subjects', 'image', 'short_discription', 'learning_outcomes', 'details', 'price', 'currency', 'installment_available', 'installment_details', 'length', 'course_type', 'address', 'online_platform']
